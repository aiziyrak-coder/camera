...
DEFAULT_AI_MODULES = [
    ...
    {"code": 6, "group": "B", "name": "Xodim/o'qituvchi davomati", "description": "Ish boshlanish/tugash vaqtini yuz orqali avtomatik qayd etish", "method": "Face recognition + timestamp log", "accuracy": 0, "threshold": 88, "sensitivity": "yuqori", "camera_count": 30, "active": True},
    ...
    {"code": 7, "group": "B", "name": "Talaba davomati", "description": "Auditoriyaga kirish/darsda ishtirok etish avtomatik qaydi", "method": "Face recognition (sinf kamerasi)", "accuracy": 0, "threshold": 90, "sensitivity": "yuqori", "camera_count": 28, "active": False},
    {"code": 8, "group": "B", "name": "Darsga kechikish", "description": "Belgilangan vaqtdan N daqiqa keyin kirish holati", "method": "Jadval bilan solishtirish (rule-based)", "accuracy": 0, "threshold": 85, "sensitivity": "o'rta", "camera_count": 28, "active": True},
    {"code": 9, "group": "B", "name": "Darsdan/ishdan erta ketish", "description": "Belgilangan tugash vaqtidan oldin xonani tark etish — oxirgi ko'rilgan vaqt (check_out) tugash vaqtidan oldin bo'lsa belgilanadi", "method": "Kirish-chiqish log tahlili (app/routers/attendance.py) — attendance_ai.py to'plagan check_out vaqtiga asoslangan qoida", "accuracy": 0, "threshold": 80, "sensitivity": "o'rta", "camera_count": 28, "active": True},
