...
DEFAULT_AI_MODULES = [
    ...
    # l5f6a7b8c9d0): 5935 talabadan atigi bittasining yuzi ro'yxatdan
    # o'tgan, ya'ni modul ishlasa ham hech kimni tanay olmaydi. Talabalar
    # biometrikasi yig'ilgach admin panelidan qayta yoqiladi.
    {"code": 7, "group": "B", "name": "Talaba davomati", "description": "Auditoriyaga kirish/darsda ishtirok etish avtomatik qaydi", "method": "Face recognition (sinf kamerasi)", "accuracy": 99.2, "threshold": 90, "sensitivity": "yuqori", "camera_count": 28, "active": False},
