...
DEFAULT_AI_MODULES = [
    ...
    {"code": 15, "group": "D", "name": "Chekish / elektron sigareta", "description": "Qo'l og'iz/burunga yaqin postura — sigareta obyektini aniqlamaydi, ikki-kadrli tasdiqlash", "method": "mediapipe Pose bilak-burun masofasi (app/jobs/smoking_ai.py)", "accuracy": 0, "threshold": 35, "sensitivity": "o'rta", "camera_count": 0, "active": True, "has_detector": True},
