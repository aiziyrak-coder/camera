  ...
  return (
    <label className="flex flex-col gap-1 text-[11px] font-semibold uppercase tracking-wide text-slate-400">
      ...
      <select
        ...
        className="rounded-xl border border-white/80 bg-white/60 px-3 py-2 text-sm font-medium normal-case text-slate-700 outline-none focus:border-indigo-300"
      >
    ...
    <div className="flex flex-wrap items-end gap-3">
      ...
      {hasActiveFilters && (
        <button
          ...
          className="rounded-xl px-3 py-2 text-xs font-semibold text-indigo-600 transition-colors hover:bg-white/60"
        >
          Filtrlarni tozalash
        </button>
      )}
